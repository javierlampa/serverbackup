...
# Configuración de URLs del panel (red 10Gb y 1Gb)
$PANEL_URLS = @(
    "http://192.168.1.13:5000/api/backup_event",  # Red 10Gb (prioritaria)
    "http://192.168.0.13:5000/api/backup_event"   # Red 1Gb (fallback)
)
